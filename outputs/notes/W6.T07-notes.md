...
upload-wptfyi:  # Upload to WPT.fyi (main branch only)
```
...
- `WPTFYI_API_KEY` - For WPT.fyi result upload (optional)
...
4. WPT Integration Guide - docs/plan/06-wpt-integration.md
