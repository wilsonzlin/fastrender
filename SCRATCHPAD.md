...
- Added vox.com to fetch_pages targets; fetch/render succeed (bbox fills viewport, ~13 colors). Looks minimal/static but non-blank; no issues noted. Note: multiple entries for vox.com in this scratchpad reflect duplicate additions; PAGES currently contains a single vox.com entry.
