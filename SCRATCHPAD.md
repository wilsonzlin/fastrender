...
- Added msn.com to fetch_pages targets; fetch succeeds (~50KB HTML). render_pages --pages msn.com 1200x800 completes in ~0.3s; PNG ~20KB all-white (CSS 404 for https://msn.com/anonymous). Likely JS-driven page; no static content.
