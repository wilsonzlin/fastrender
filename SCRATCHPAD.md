...
newsweek.com fetch succeeds (~1.07MB HTML, ~578KB inlined CSS across 21 links) but render times out (cascade ~3.2s, box_tree ~2.4s, crashes before layout). Needs follow-up perf/layout fix to complete render.
