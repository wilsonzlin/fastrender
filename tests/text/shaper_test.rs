...
use fastrender::text::shaper::GlyphCluster;
use fastrender::text::shaper::GlyphPosition;
use fastrender::text::shaper::Script;
use fastrender::text::shaper::ShapedGlyphs;
use fastrender::text::shaper::TextDirection;
use fastrender::text::shaper::TextShaper;
...
fn test_measure_width_empty() {
  ...
  let width = shaper
    .measure_width("", &font, 16.0)
    .expect("Should measure empty");
