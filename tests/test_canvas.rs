...
fn test_canvas_creation_various_sizes() {
    // Small canvas
    let canvas = Canvas::new(1, 1, Color::WHITE);
    assert!(canvas.is_ok());
    ...
    // Large canvas
    let canvas = Canvas::new(4096, 4096, Color::WHITE);
    assert!(canvas.is_ok());
}
...
fn test_canvas_creation_with_colors() {
    // White background
    let canvas = Canvas::new(10, 10, Color::WHITE).unwrap();
    ...
    // Black background
    let canvas = Canvas::new(10, 10, Color::BLACK).unwrap();
    let data = canvas.pixmap().data();
    assert_eq!(data[0], 0);
    assert_eq!(data[1], 0);
    assert_eq!(data[2], 0);
    ...
    let canvas = Canvas::new(10, 10, Color::TRANSPARENT).unwrap();
    let data = canvas.pixmap().data();
    assert_eq!(data[0], 0);
    assert_eq!(data[1], 0);
    assert_eq!(data[2], 0);
...
fn test_draw_rect_at_origin() {
    let mut canvas = Canvas::new(50, 50, Color::WHITE).unwrap();

    let rect = Rect::from_xywh(0.0, 0.0, 10.0, 10.0);
    canvas.draw_rect(rect, Color::rgb(0, 255, 0));
...
fn test_draw_multiple_rects() {
    ...
    canvas.draw_rect(Rect::from_xywh(0.0, 0.0, 50.0, 50.0), Color::rgb(255, 0, 0));
    canvas.draw_rect(Rect::from_xywh(25.0, 25.0, 50.0, 50.0), Color::rgb(0, 255, 0));
    canvas.draw_rect(Rect::from_xywh(50.0, 50.0, 50.0, 50.0), Color::rgb(0, 0, 255));
...
fn test_draw_rounded_rect_uniform() {
    ...
    canvas.draw_rounded_rect(rect, radii, Color::rgb(100, 150, 200));
...
fn test_draw_rounded_rect_different_radii() {
    ...
    canvas.draw_rounded_rect(rect, radii, Color::rgb(200, 100, 50));
...
fn test_draw_rounded_rect_large_radius() {
    ...
    canvas.draw_rounded_rect(rect, radii, Color::rgb(50, 100, 200));
...
fn test_stroke_rounded_rect() {
    ...
    canvas.stroke_rounded_rect(rect, radii, Color::BLACK, 3.0);
...
fn test_draw_circle() {
    ...
    canvas.draw_circle(Point::new(50.0, 50.0), 30.0, Color::rgb(255, 128, 0));
...
fn test_stroke_circle() {
    ...
    canvas.stroke_circle(Point::new(50.0, 50.0), 40.0, Color::BLACK, 2.0);
...
fn test_scale_transform() {
    ...
    canvas.draw_rect(Rect::from_xywh(0.0, 0.0, 10.0, 10.0), Color::rgb(255, 0, 0));
...
fn test_draw_with_opacity() {
    ...
    canvas.set_opacity(0.5);
    canvas.draw_rect(Rect::from_xywh(10.0, 10.0, 80.0, 80.0), Color::rgb(255, 0, 0));
...
fn test_clip_rect() {
    ...
    canvas.draw_rect(Rect::from_xywh(0.0, 0.0, 10.0, 10.0), Color::rgb(0, 0, 255));
...
fn test_blend_mode_multiply() {
    ...
    // Draw background
    canvas.draw_rect(Rect::from_xywh(0.0, 0.0, 100.0, 100.0), Color::rgb(200, 200, 200));

    // Set multiply blend
    canvas.set_blend_mode(BlendMode::Multiply);

    // Draw overlapping rect
    canvas.draw_rect(Rect::from_xywh(25.0, 25.0, 50.0, 50.0), Color::rgb(255, 100, 100));
...
fn test_blend_mode_screen() {
    let mut canvas = Canvas::new(100, 100, Color::BLACK).unwrap();

    canvas.set_blend_mode(BlendMode::Screen);
    canvas.draw_rect(Rect::from_xywh(20.0, 20.0, 60.0, 60.0), Color::rgb(100, 100, 200));
...
fn test_draw_text_empty() {
    let mut canvas = Canvas::new(200, 100, Color::WHITE).unwrap();
    ...
    canvas.draw_text(Point::new(10.0, 50.0), &[], &font, 16.0, Color::BLACK);
...
fn test_draw_text_with_glyphs() {
    let mut canvas = Canvas::new(200, 50, Color::WHITE).unwrap();
...
fn test_draw_transparent() {
    ...
    canvas.draw_rect(Rect::from_xywh(0.0, 0.0, 50.0, 50.0), Color::TRANSPARENT);
...
fn test_draw_zero_size_rect() {
    ...
    // Zero-width rect
    canvas.draw_rect(Rect::from_xywh(10.0, 10.0, 0.0, 20.0), Color::rgb(255, 0, 0));

    // Zero-height rect
    canvas.draw_rect(Rect::from_xywh(10.0, 10.0, 20.0, 0.0), Color::rgb(255, 0, 0));
...
fn test_draw_outside_bounds() {
    ...
    canvas.draw_rect(Rect::from_xywh(100.0, 100.0, 20.0, 20.0), Color::rgb(255, 0, 0));

    // Rect partially outside
    canvas.draw_rect(Rect::from_xywh(-10.0, -10.0, 30.0, 30.0), Color::rgb(0, 0, 255));
...
fn test_draw_negative_radius_circle() {
    ...
    canvas.draw_circle(Point::new(25.0, 25.0), -10.0, Color::rgb(255, 0, 0));
...
fn test_complex_scene() {
    let mut canvas = Canvas::new(200, 200, Color::rgb(240, 240, 240)).unwrap();

    // Background rectangle
    canvas.draw_rect(Rect::from_xywh(10.0, 10.0, 180.0, 180.0), Color::WHITE);
    ...
    canvas.draw_circle(Point::new(100.0, 100.0), 15.0, Color::rgb(100, 255, 100));
...
fn test_layered_opacity() {
    ...
    canvas.save();
    canvas.set_opacity(0.5);
    canvas.draw_rect(Rect::from_xywh(20.0, 20.0, 60.0, 60.0), Color::rgb(0, 255, 0));
    canvas.restore();

    // Layer 3: Back to full opacity
    canvas.draw_rect(Rect::from_xywh(35.0, 35.0, 30.0, 30.0), Color::rgb(0, 0, 255));
...
fn test_transformed_rendering() {
    ...
    canvas.draw_rect(Rect::from_xywh(-10.0, -10.0, 20.0, 20.0), Color::rgb(255, 0, 0));
    canvas.restore();
    ...
    canvas.draw_rect(Rect::from_xywh(0.0, 0.0, 50.0, 50.0), Color::rgb(0, 0, 255));
    canvas.restore();
