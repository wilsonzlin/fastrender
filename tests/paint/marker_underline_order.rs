...
fn marker_underline_paints_with_text() {
    ...
    style.text_decoration.thickness = TextDecorationThickness::Length(fastrender::style::values::Length::px(2.0));
    ...
    .expect("underline");
    let glyph_bbox =
        bounding_box_for_color(&pixmap, |(r, g, b, a)| a > 0 && r < 32 && g < 32 && b < 32).expect("glyph");
