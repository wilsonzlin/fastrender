...
pipeline uses `ComputedStyle.custom_properties: HashMap<String, CustomPropertyValue>` plus
...
uses: store custom properties in a `HashMap<String, CustomPropertyValue>` and
