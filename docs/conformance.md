...
| Animation | Scroll/view timeline animations | ⚠️ | [src/animation/mod.rs](../src/animation/mod.rs) | [tests/animation_tests.rs](../tests/animation_tests.rs) | Samples @keyframes on scroll/view timelines; time-based animations/transitions are not yet executed. |
| Accessibility | Accessibility tree export | ⚠️ | [src/accessibility.rs](../src/accessibility.rs) | [tests/accessibility_test.rs](../tests/accessibility_test.rs) | Static accessibility tree with HTML/ARIA role/name/state mapping; no dynamic events or focus navigation. |
