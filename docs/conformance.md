...
| Paint | Text & decorations | ⚠️ | [src/paint/text_rasterize.rs](../src/paint/text_rasterize.rs)<br>[src/paint/text_shadow.rs](../src/paint/text_shadow.rs)<br>[src/paint/display_list_renderer.rs](../src/paint/display_list_renderer.rs) | [tests/paint/text_rasterize_test.rs](../tests/paint/text_rasterize_test.rs) | Text shadows, underline/overline/line-through with offsets/decoration thickness, emphasis marks, ruby annotations painted inline. Color glyphs: [`TextRasterizer`](../src/paint/text_rasterize.rs) draws CBDT/CBLC+sbix PNG bitmaps, SVG-in-OT, and COLR/CPAL v0 solid layers; COLR v1 paint graphs/composite modes are not rendered. Display-list/Canvas text uses monochrome outlines tinted by the text color (ignores color tables). Palette selection is fixed to CPAL palette 0 (no `font-palette`/`@font-palette-values`). See [notes/color-fonts.md](notes/color-fonts.md). |
| Text | Shaping pipeline | ⚠️ | [src/text/pipeline.rs](../src/text/pipeline.rs) | [tests/text/pipeline_test.rs](../tests/text/pipeline_test.rs) | UAX #9 bidi, script itemization, RustyBuzz shaping with OpenType features/variations. Color glyph path prefers CBDT/CBLC+sbix PNG bitmaps → SVG-in-OT → COLR/CPAL v0 solids via [`text/color_fonts`](../src/text/color_fonts/mod.rs); COLR v1 paint graph unsupported (outline fallback). Palette selection comes from `font-palette`/`@font-palette-values` with CPAL `paletteTypes` flags for light/dark palettes. See [notes/color-fonts.md](notes/color-fonts.md). |
