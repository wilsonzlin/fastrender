...
**Deliverable:** Create `/docs/plan/00-architecture-decisions.md`
...
- [ ] `/docs/plan/00-architecture-decisions.md` exists with:
...
- [`docs/plan/01-type-system.md`](01-type-system.md)
