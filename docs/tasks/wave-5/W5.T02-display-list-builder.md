...
outputs:
  ...
  - "docs/tasks/notes/W5.T02-notes.md"
skills_required:
  - "Rust"
  - "Tree traversal"
  - "Graphics primitives"
...
### Required Reading
1. **docs/tasks/notes/W5.T01-notes.md**: DisplayList types
2. **docs/tasks/notes/W2.T03-notes.md**: Fragment tree structure
3. **docs/paint/display-list.md**: Display list design
...
Create: **`docs/tasks/notes/W5.T02-notes.md`**
