...
### Required Reading
1. **outputs/notes/W1.R01-notes.md**: IFC section from CSS research
2. **outputs/notes/W4.T05-notes.md**: Text shaping API
3. **outputs/notes/W4.T09-notes.md**: Line breaking API
4. **outputs/notes/W3.T18-notes.md**: Font metrics API
5. **docs/plan/02-inline-layout.md**: Implementation strategy
...
Create: **`outputs/notes/W4.T12-notes.md`**
