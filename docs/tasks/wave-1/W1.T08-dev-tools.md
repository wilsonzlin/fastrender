...
outputs:
  ...
  - "justfile"
  - "CONTRIBUTING.md"
  - "docs/tasks/notes/W1.T08-notes.md"
skills_required:
...
if [ -d .git/rebase-merge ] || [ -d .git/rebase-apply ]; then
    echo "⏭️  Skipping pre-commit hook during rebase"
    exit 0
fi
...
if ! cargo clippy --all-targets --all-features -- -D warnings; then
    echo "❌ Clippy found issues. Run: just lint"
    exit 1
fi
...
Create: **`docs/tasks/notes/W1.T08-notes.md`**
...
- ✅ Test job configured
- ✅ Clippy job configured
- ✅ Format job configured
- ✅ Docs job configured
- ✅ Audit job configured
- ✅ Caching configured
- ✅ All jobs passing
