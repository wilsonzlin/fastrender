...
### Required Reading
1. **outputs/notes/W6.T01-notes.md**: FC factory integration
2. **outputs/notes/W5.T08-notes.md**: Rasterizer API
3. **docs/plan/01-integration.md**: Integration strategy
...
Create: **`outputs/notes/W6.T02-notes.md`**
