...
### Required Reading
1. **outputs/notes/W1.R01-notes.md**: CSS formatting context concepts
2. **outputs/notes/W2.T01-notes.md**: BoxNode API
3. **outputs/notes/W2.T03-notes.md**: FragmentNode API
4. **outputs/notes/W2.T04-notes.md**: LayoutConstraints API
...
Create: **`outputs/notes/W2.T07-notes.md`**
