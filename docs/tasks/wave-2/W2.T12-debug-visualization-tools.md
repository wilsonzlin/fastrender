...
inputs:
  ...
  - "outputs/notes/W2.T06-notes.md"
  - "src/tree/box_tree.rs"
outputs:
  - "src/debug/tree_printer.rs"
  - "src/debug/mod.rs"
  - "outputs/notes/W2.T12-notes.md"
skills_required:
  - "Rust"
  - "String formatting"
  - "Tree traversal"
  - "Terminal output"
context_files:
  - "docs/plan/01-debugging-tools.md"
verification:
...
### Required Reading
1. **outputs/notes/W2.T01-notes.md**: BoxNode structure
2. **outputs/notes/W2.T03-notes.md**: Fragment structure (if exists)
3. **outputs/notes/W2.T06-notes.md**: DebugInfo structure (if separate task)
...
Create: **`outputs/notes/W2.T12-notes.md`**
