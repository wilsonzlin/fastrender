...
### Required Reading
1. **docs/tasks/notes/W2.T07-notes.md**: FormattingContext trait contract
2. **docs/tasks/notes/W2.T08-notes.md**: FormattingContextType enum
...
Create: **`docs/tasks/notes/W2.T09-notes.md`**
...
- Check `docs/tasks/notes/W2.T08-notes.md` for FC type determination
