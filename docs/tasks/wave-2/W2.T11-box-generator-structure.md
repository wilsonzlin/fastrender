...
inputs:
  ...
  - "docs/tasks/notes/W2.T02-notes.md"
  - "src/tree/box_tree.rs"
outputs:
  - "src/tree/box_generation.rs"
  - "docs/tasks/notes/W2.T11-notes.md"
skills_required:
  - "Rust"
...
### Required Reading
1. **docs/tasks/notes/W2.T01-notes.md**: BoxNode API
2. **docs/tasks/notes/W2.T02-notes.md**: BoxType variants (if separate task)
3. **CSS 2.1 Section 9.2**: Box generation
4. **docs/tasks/notes/W1.R01-notes.md**: Formatting context concepts
5. **docs/core/box-generation.md**: Box generation architecture
...
Create: **`docs/tasks/notes/W2.T11-notes.md`**
...
- Check `docs/tasks/notes/W2.T01-notes.md` for BoxNode API
- See `docs/tasks/notes/W1.R01-notes.md` for formatting context concepts
