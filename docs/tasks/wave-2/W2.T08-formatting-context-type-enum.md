...
### Required Reading
1. **docs/tasks/notes/W1.T05-notes.md**: Display type API
2. **docs/tasks/notes/W1.R01-notes.md**: CSS formatting context concepts
...
- `docs/core/formatting-contexts.md` - FC architecture
...
Create: **`docs/tasks/notes/W2.T08-notes.md`**
...
- Check `docs/tasks/notes/W1.R01-notes.md` for FC concepts
- See `docs/tasks/notes/W1.T05-notes.md` for Display API
