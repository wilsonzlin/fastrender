...
### Required Reading
1. **docs/tasks/notes/W2.T07-notes.md**: FormattingContext trait API
2. **docs/tasks/notes/W2.T09-notes.md**: FormattingContextFactory API
3. **CSS 2.1 Section 9**: Visual formatting model
4. **docs/core/formatting-contexts.md**: Engine architecture
...
Create: **`docs/tasks/notes/W2.T10-notes.md`**
...
- Review `docs/tasks/notes/W2.T07-notes.md` for FormattingContext trait
- Check `docs/tasks/notes/W2.T09-notes.md` for Factory usage
