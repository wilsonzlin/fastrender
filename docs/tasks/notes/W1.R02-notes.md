...
**Characteristics:**
- **Slow**: O(rows × columns) - must analyze ALL cells
...
```
For each cell:
  - Layout with wrapping allowed → min-content
  - Layout without wrapping → max-content
...
**Complexity:** O(rows × columns × content_measurement_cost)
...
- Fixed: table width → column widths → cell layout
- Auto: cell content → column constraints → table width → final column widths → cell layout
...
```
Cell content constraints ──→ Column min/max widths
                               ↓
Available width + constraints ─→ Actual column widths
                               ↓
...
**Operations:**
- Measure each cell min/max: O(rows × columns × measure_cost)
- Distribute spanning cells: O(spanning_cells × spanned_columns)
- Final distribution: O(columns)

**Typical performance:**
- Small table (10×10): 5-10ms
- Medium table (50×20): 50-100ms
- Large table (100×50): 500ms-1s
...
✅ All examples from CSS Tables Level 3 Section 3-7 extracted
✅ All examples from CSS 2.1 Section 17.2-17.6 extracted
✅ 15+ concrete test cases documented in research doc
...
1. ✅ Empty first row in fixed layout
2. ✅ Colspan in first row (fixed layout)
3. ✅ Multiple overlapping spanning cells
4. ✅ Percentage widths with auto table width
5. ✅ Deeply nested tables
6. ✅ Malformed structures requiring anonymous boxes
7. ✅ Zero-width columns
8. ✅ Table wider than containing block
9. ✅ Border conflicts from 4+ sources
10. ✅ Rowspan beyond table end
...
1. **CSS Tables Module Level 3**
   ...
   - Section 3: Table Structure ✅ Complete
   - Section 4: Grid Layout ✅ Complete
   - Section 5: Row/Column Sizing ✅ Complete
   - Section 6: Fixed Table Layout ✅ Complete
   - Section 7: Automatic Table Layout ✅ Complete

2. **CSS 2.1 Chapter 17: Tables**
   https://www.w3.org/TR/CSS21/tables.html
   - Section 17.2: The CSS table model ✅ Complete
   - Section 17.2.1: Anonymous table objects ✅ Complete
   - Section 17.5: Visual layout of table contents ✅ Complete
   - Section 17.5.2.1: Fixed table layout ✅ Complete
   - Section 17.5.2.2: Automatic table layout ✅ Complete
   - Section 17.6: Borders ✅ Complete
   - Section 17.6.2: The collapsing border model ✅ Complete
   - Section 17.6.2.1: Border conflict resolution ✅ Complete

### Supporting Research

3. **docs/layout/table.md**
   - Context on V1's failed approach ✅ Read
   - Overview of required implementation ✅ Read

4. **docs/architecture/foundation.md**
   - Research methodology ✅ Read
   - Context on project goals ✅ Read
