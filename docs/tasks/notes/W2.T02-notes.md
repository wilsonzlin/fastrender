...
2. **docs/tasks/notes/W2.T02-notes.md** (this file)
...
4. **docs/core/type-system.md:** Architecture guidance for type system
5. **docs/core/box-generation.md:** Box generation algorithm
