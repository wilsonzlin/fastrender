...
outputs:
  ...
  - "docs/tasks/notes/W3.T05-notes.md"
skills_required:
  - "Rust"
...
### Required Reading
1. **docs/tasks/notes/W1.R01-notes.md**: Margin collapsing research
2. **docs/tasks/notes/W3.T04-notes.md**: Block layout integration
3. **docs/layout/block.md**: Margin collapse section
...
Create: **`docs/tasks/notes/W3.T05-notes.md`**
