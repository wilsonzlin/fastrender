...
2. **outputs/notes/W2.T07-notes.md**: FormattingContext trait
3. **docs/plan/02-table-layout.md**: Complete implementation guide
...
Create: **`outputs/notes/W3.T06-notes.md`**
