...
### Required Reading
1. **outputs/notes/W1.R01-notes.md**: Complete CSS research (focus on BFC section)
2. **outputs/notes/W2.T07-notes.md**: FormattingContext trait contract
3. **outputs/notes/W2.T01-notes.md**: BoxNode API
4. **docs/plan/02-block-layout.md**: Implementation strategy
...
Create: **`outputs/notes/W3.T04-notes.md`**
