...
- Guard rails: `just guard-tests` runs the churn guards (README presence + CLI example, style regression fixture presence, fetch_and_render exit regression) to catch accidental deletions before push
