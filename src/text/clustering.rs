...
pub fn cluster_range_advance(clusters: &[GlyphCluster], start_cluster: usize, end_cluster: usize) -> f32 {
    clusters
        .iter()
        .skip(start_cluster)
...
pub fn get_selection(clusters: &[GlyphCluster], start_byte: usize, end_byte: usize) -> ClusterSelection {
...
mod tests {
    ...
    fn test_find_cluster_at_byte_after() {
        ...
        assert_eq!(find_cluster_at_byte(&clusters, 100), ClusterLookup::AfterAll);
    }
