...
use types::{
    ...
    HyphensMode, ImageOrientation, ImageRendering, Isolation, JustifyContent, LineBreak, LineHeight, ListStyleImage,
    ...
    TextTransform, TextUnderlineOffset, TextUnderlinePosition, TransformOrigin, UnicodeBidi, VerticalAlign, WhiteSpace,
